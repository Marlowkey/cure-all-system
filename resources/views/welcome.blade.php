        ...
        <section id="hero">
            <div class="col-md-6 d-flex align-items-center">
                <div class="landing-container" id="para">
                    <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam sit amet
                        feugiat lorem, in faucibus justo. Donec sodales non nisi sit amet maximus.
                        Quisque convallis dolor eget justo tristique, a feugiat sapien volutpat.</p>
                </div>
            </div>
        </section>
            ...
            <div class="pro-container">
                ...
                <div class="pro">
                    <a href="{{ asset('WEB/assets2/sproduct.php?productId=16') }}">
                        <img src="{{ asset('Capstone1.0/img/losartan.jpg') }}" alt="none">
                    </a>
                    <div class="des">
                ...
                <!-- Continue for all products similarly -->
